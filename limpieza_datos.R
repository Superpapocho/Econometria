...
# Dirección en la que quiere guardarse el archivo
...
# Me parecio que la variable duración nos puede dar una idea de la concentración del encuestado
...
# Se unen Tb#percepcion_# con Cb#percepcion_# en una sola variable según sea tratamiento o control 
...
# Se unen Tb#verdad_# con Cb#verdad_# en una sola variable según sea tratamiento o control 
...
# Vector de variables según el tipo al que se va a convertir
...
# Proporción de respuestas contestadas correctamente
data_project = data_project %>% mutate(precision=suma/8)
mean(data_project$precision)

# Contando el número de veces que las personas seleccionaron percepcion "Positiva"
...
# Contando el número de veces que las personas seleccionaron percepcion "Ni positiva ni negativa"
...
# Contando el número de veces que las personas seleccionaron percepcion "Negativa"
...
# Suma de las variables anteriores, número de veces que contestan "Positiva", "Ni positiva ni negativa", "Negativa
